...
class CADGenerator:
    ...
    def _format_prompt(self, instruction):
        system_message = (
            "You are an expert in designing layouts for industrial robot workspaces. "
            "Based on the user's natural language description, please generate accurate drawing data in JSON format."
        )
        prompt = (
